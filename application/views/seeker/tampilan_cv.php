                 ...
                 <div class="col-md-4 col-xl-4 p-3" style="border: 1px solid #d8d8d8;border-radius: 15px">
                  <div class="row">
                    ...
                    <?php if (count($upload_resume) > 0): ?>
                      ...
                      <div class="col-md-12 col-xl-12 text-center  w-100">
                        <a href="<?php echo $up->resume_lampiran ?>" target="_blank" class="genric-btn danger large " style="border-top-left-radius: 15px;border-bottom-left-radius: 15px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;">Lihat Resume</a>
                         <a href="<?php echo base_url()?>cv/profile/<?php echo $up->user_id ?>" target="_blank" class="genric-btn primary large">Lihat Profile</a>
