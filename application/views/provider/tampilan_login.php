    <main>
      ...
      <div class="slider-area">
        ...
        <div class="container flashdatart" data-title="<?php echo $this->session->flashdata('title'); ?>" data-text="<?php echo $this->session->flashdata('text'); ?>" data-icon="<?php echo $this->session->flashdata('icon'); ?>">
          ...
          <form method="post" action="<?php echo base_url('provider/cek_login') ?>" id="form-login">
            <div class="row mt-5 p-3 mb-5 align-items-center">
              ...
              <div class="col-lg-6 mb-5 mt-5">
                <div class="hero-cap text-center">
                  <h2>Job Provider</h2>
                  <p class="text-light">Temukan calon karyawan yang sesuai dengan kriteria perusahaan anda</p>
                </div>
                <div class="row justify-content-center mt-4">
                  ...
                  <div class="col-lg-8 text-center">
                    <span class="text-light">Belum Punya Akun ? Silahkan <span class="text-light "><span style="font-weight: bold;"><a href="<?php echo base_url('provider/register') ?>">Daftar</a></span>
                  </div>
                </div>
              </div>
