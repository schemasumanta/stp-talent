          ...
          <div class="card">
           ...
           <div class="card-body">
            <div class="table-responsive">
              ...
              <table  id="tabel_job_posting"  class="table table-striped table-bordered " style="width: 100%; height: 30%; overflow-y: scroll;overflow-x: scroll; font-size: 13px; text-align: left;">
                <thead>
