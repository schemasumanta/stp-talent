            ...
            <div class="col-xl-8">
              ...
              <form action="javascript:;" id="form_cari" class="search-box">
                <div class="input-form">
                  <input type="text" name="nama_lowongan" id="nama_lowongan" placeholder="Job Title or Keyword" />
                </div>
                ...
                <div class="search-form">
                  <button type="button" id="btnSave" onclick="cari()" class="btn btn-danger btn-lg">Find job</button>
                </div>
              </form>
            </div>
          </div>
          ...
          <div class="home-blog-single mb-30">
            <div class="blog-img-cap">
              ...
              <div class="blog-cap">
                <p>| Properties</p>
                <h3>
                  <a href="single-blog.html">Finding the right Co-Working Spaces.</a>
                </h3>
          ...
          <div class="home-blog-single mb-30">
            <div class="blog-img-cap">
              ...
              <div class="blog-cap">
                <p>| Properties</p>
                <h3>
                  <a href="single-blog.html">How "Work from Anywhere" affect F&B Business
                  </a>
                </h3>
                <a href="#" class="more-btn">Read more »</a>
              </div>
