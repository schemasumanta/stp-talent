            ...
            <div class="col-xl-10">
                ...
                <div class="job-items">
                  <div class="company-img">
                    <a href="job_details.html"
                      ><img src="assets/img/icon/MetroTV.png" alt=""
                    /></a>
                  </div>
                  <div class="job-tittle">
                    <a href="job_details.html"><h4>Editor & Reporter</h4></a>
                    <ul>
                      <li>News & Media</li>
                      <li><i class="fas fa-map-marker-alt"></i>DKI Jakarta</li>
                      <li>Rp 8,000,000 - Rp 12,000,000</li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  <div class="company-img">
                    <a href="job_details.html"
                      ><img src="assets/img/icon/bukalapakicon.png" alt=""
                    /></a>
                  </div>
                  <div class="job-tittle">
                    <a href="job_details.html"><h4>Risks Analyst</h4></a>
                    <ul>
                      <li>E-Commerce</li>
                      <li><i class="fas fa-map-marker-alt"></i>DKI Jakarta</li>
                      <li>Rp 20,000,000 - Rp 30,000,000</li>
                    </ul>
                  </div>
                </div>
                <div class="items-link f-right">
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  <div class="company-img">
                    <a href="job_details.html"
                      ><img src="assets/img/icon/ifars.png" alt=""
                    /></a>
                  </div>
                  <div class="job-tittle">
                    <a href="job_details.html"><h4>Apotechary</h4></a>
                    <ul>
                      <li>Medical & Pharmacy</li>
                      <li>
                        <i class="fas fa-map-marker-alt"></i>Solo, Jawa Tengah
                      </li>
                      <li>Rp 7,000,000 - Rp 9,000,000</li>
                    </ul>
                  </div>
                </div>
                <div class="items-link f-right">
              ...
              <div class="single-job-items mb-30">
                <div class="job-items">
                  <div class="company-img">
                    <a href="job_details.html"
                      ><img src="assets/img/icon/lippo.png" alt=""
                    /></a>
                  </div>
                  <div class="job-tittle">
                    <a href="job_details.html"><h4>Architect</h4></a>
                    <ul>
                      <li>Real Estate</li>
                      <li>
                        <i class="fas fa-map-marker-alt"></i>Surabaya, Jawa
                        Timur
                      </li>
                      <li>Rp 45,000,000 - Rp 65,000,000</li>
                    </ul>
                  </div>
                </div>
                <div class="items-link f-right">
