               ...
               <div class="job-items">
                 <div class="job-tittle">
                   <?php if (!$this->session->login) { ?>
                     <a href="<?php echo base_url() ?>landing/login/<?php echo $job->lowongan_id ?>" class="bookmark_lowongan" data="<?php echo $job->lowongan_id ?>" style="color: #F82C2C;
                   display: block;
                   padding: 4px 33px;
                   text-align: center;
                   ...
                   <?php  } else { ?>
                     <?php if ($this->session->user_level == 2) {
                        ...
                        if ($cek_bookmark > 0) { ?>
                         <a href="javascript:;" class="bookmark_lowongan item_bookmark" data-job="<?php echo $job->lowongan_id ?>" data-status="0" style="color: #F82C2C;
                      display: block;
                      padding: 4px 33px;
                      text-align: center;
                      background: transparent!important;
                      ...
                      margin-bottom: 25px;"><i class="fas fa-bookmark fa-3x"></i></a>
                       ...
                       <?php } else { ?>
                         <a href="javascript:;" class="bookmark_lowongan item_bookmark" data-job="<?php echo $job->lowongan_id ?>" data-status="1" style="color: #b2b2b2;
                      display: block;
                      padding: 4px 33px;
                      text-align: center;
                      background: transparent!important;
                   ...
                   <?php if ($this->session->login) { ?>
                     <?php if ($this->session->user_level == 2) { ?>
                       <?php if ($lamaran == 0) { ?>
                         ...
                         <?php } else { ?>
                           <a href="javascript:;" class="genric-btn2 danger large w-50 btn_pesan">Apply Now</a>
                         <?php }; ?>
                       <?php } else { ?>
