...
<ul class="navbar-nav bg-danger sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    $menu_user = $this->db->query("SELECT mr.* FROM tbl_admin_role as ar JOIN tbl_master_role as mr ON ar.role_id = mr.role_id WHERE ar.user_id = $userid ")->result();
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <img class="img-profile rounded-circle" src="<?php echo base_url() . $this->session->user_foto ?>">
                    </a>
