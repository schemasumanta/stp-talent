...
class Job extends CI_Controller
{
	...
	public function simpan_post()
	{
		...
		$cek_premium = $this->db->get_where('tbl_langganan_premium', ['user_id' => $user_id])->row();
		if ($cek_premium) {
                 ...
                 <div class="job-items">
                   ...
                   <div class="job-tittle job-tittle2">
                     <a href="' . base_url('job/detail/') . $l->lowongan_id . '">
                       <h4>' . $l->lowongan_judul . '<img src="' . base_url('assets_admin/img/badge_premium.svg') . '" alt="premium_user"></h4>
                     </a>
                     <ul>
